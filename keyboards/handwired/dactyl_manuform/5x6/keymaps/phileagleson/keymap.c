...
#define CTL__T RCTL_T(KC_T)
#define OPT_N LOPT_T(KC_N)
#define CUS_S RGUI_T(KC_S)

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_DVORAK] = LAYOUT_5x6(
      KC_GRV,  KC_1,    KC_2,    KC_3,   KC_4,   KC_5,                     KC_6,   KC_7,    KC_8,    KC_9,    KC_0,    KC_EQL,
      KC_TAB,  KC_QUOT, KC_COMM, KC_DOT,  KC_P,  KC_Y,                      KC_F,   KC_G,    KC_C,    KC_R,    KC_L,    KC_SLASH,
      MT(MOD_RSFT,KC_ESC),  CUS_A,   OPT_O,   CTL_E,   SFT_U, KC_I,                      KC_D,   SFT_H,   CTL__T,   OPT_N,   CUS_S,   KC_MINUS,
